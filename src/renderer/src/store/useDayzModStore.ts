...
export const useDayzModStore = create<DayzModStore>()(
  persist(
    (set) => ({
      ...
      addPendingDownload: (serverId, mod) =>
        set((state) => {
      ...
      removePendingDownload: (serverId, modId) =>
        set((state) => {
          const serverDownloads = state.pendingDownloads[serverId] || {}
      ...
      updatePendingProgress: (serverId, modId, progress, msg) =>
        set((state) => {
          const serverDownloads = state.pendingDownloads[serverId] || {}
