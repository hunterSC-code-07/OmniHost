...
interface ModalStore {
  ...
  dayzMissingDepsModal: {
    isOpen: boolean
    depDetails: any[]
    onConfirm?: (deps: any[]) => void
    onCancel?: () => void
  }
  openDayzMissingDepsModal: (
    depDetails: any[],
    onConfirm: (deps: any[]) => void,
    onCancel?: () => void
  ) => void
...
export const useModalStore = create<ModalStore>((set) => ({
  ...
  openCreateServerModal: (defaultType?: string) =>
    set({ isCreateServerModalOpen: true, createServerDefaultType: defaultType || null }),
  closeCreateServerModal: () =>
    set({ isCreateServerModalOpen: false, createServerDefaultType: null }),

  openDeleteModal: (serverId) => set({ serverToDeleteId: serverId }),
  closeDeleteModal: () => set({ serverToDeleteId: null }),

  openSteamLoginModal: (action, callback) =>
    set({
  ...
  closeDayzInfoModal: () =>
    set((state) => ({ dayzInfoModal: { ...state.dayzInfoModal, isOpen: false } })),

  dayzMissingDepsModal: { isOpen: false, depDetails: [] },
  openDayzMissingDepsModal: (depDetails, onConfirm, onCancel) =>
    set({ dayzMissingDepsModal: { isOpen: true, depDetails, onConfirm, onCancel } }),
  closeDayzMissingDepsModal: () =>
    set((state) => ({
      dayzMissingDepsModal: {
        ...state.dayzMissingDepsModal,
        isOpen: false,
        onConfirm: undefined,
        onCancel: undefined
      }
  ...
  openDayzUninstallSingleModal: (modId, modName, onConfirm) =>
    set({ dayzUninstallSingleModal: { isOpen: true, modId, modName, onConfirm } }),
  closeDayzUninstallSingleModal: () =>
    set((state) => ({
      dayzUninstallSingleModal: {
        ...state.dayzUninstallSingleModal,
        isOpen: false,
        onConfirm: undefined
      }
    })),
  ...
  openDayzUninstallAllModal: (modsCount, onConfirm) =>
    set({ dayzUninstallAllModal: { isOpen: true, modsCount, onConfirm } }),
  closeDayzUninstallAllModal: () =>
    set((state) => ({
      dayzUninstallAllModal: { ...state.dayzUninstallAllModal, isOpen: false, onConfirm: undefined }
    })),

  dayzRebuildConfirmModal: { isOpen: false },
  openDayzRebuildConfirmModal: (onConfirm) =>
    set({ dayzRebuildConfirmModal: { isOpen: true, onConfirm } }),
  closeDayzRebuildConfirmModal: () =>
    set((state) => ({
      dayzRebuildConfirmModal: {
        ...state.dayzRebuildConfirmModal,
        isOpen: false,
        onConfirm: undefined
      }
    })),
  ...
  openDayzDependencyResultModal: (modTitle, deps) =>
    set({ dayzDependencyResultModal: { isOpen: true, modTitle, deps } }),
  closeDayzDependencyResultModal: () =>
    set((state) => ({
      dayzDependencyResultModal: { ...state.dayzDependencyResultModal, isOpen: false }
    }))
}))
