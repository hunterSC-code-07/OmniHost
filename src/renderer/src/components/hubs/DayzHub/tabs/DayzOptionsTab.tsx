...
import { useDayzOptions } from '../../../../hooks/useDayzOptions'

export const DayzOptionsTab: React.FC = () => {
  const {
    isLoading,
    isSaving,
    hostname,
    ...
    setServerTimeAcceleration,
    serverNightTimeAcceleration,
    setServerNightTimeAcceleration,
    template,
    setTemplate,
    availableMissions,
    handleSave
          ...
          <div className="flex justify-between items-end">
            <div>
              ...
              <p className="text-sm text-gray-400">
                Configure your DayZ server settings. These changes apply on the next restart.
              </p>
            </div>
            <button
              onClick={handleSave}
          ...
          <div className="glass-panel p-6 rounded-xl space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <CustomNumberInput value={maxPlayers} onChange={setMaxPlayers} min={1} max={127} />
              </div>
