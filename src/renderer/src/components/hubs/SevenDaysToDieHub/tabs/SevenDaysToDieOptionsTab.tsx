          ...
          >
            <div className="space-y-6">
              ...
              <div className="sevendays-input-row">
                ...
                <div className="sevendays-input-container">
                  <span
                    className="sevendays-input-arrow"
                    onClick={() => handleCycle(gameWorld, gameWorldOptions, setGameWorld, -1)}
                  >
                    &lt;
                  </span>
                  <div
                    className="sevendays-input flex items-center justify-center select-none"
                    onClick={() => handleCycle(gameWorld, gameWorldOptions, setGameWorld, 1)}
                  >
                    {gameWorld}
                  </div>
                  ...
                  <div className="sevendays-input-row">
                    ...
                    <div className="sevendays-input-container">
                      <span
                        className="sevendays-input-arrow"
                        onClick={() =>
                          handleCycle(gameDifficulty, difficultyOptions, setGameDifficulty, -1)
                        }
                      >
                        &lt;
                      </span>
                      ...
                      >
                        {difficultyLabels[difficultyOptions.indexOf(String(gameDifficulty))] ||
                          gameDifficulty}
                      </div>
                      <span
                        className="sevendays-input-arrow"
                  ...
                  <div className="sevendays-input-row">
                    ...
                    <div className="sevendays-input-container">
                      <span
                        ...
                        onClick={() =>
                          handleCycleNumber(
                            parseInt(serverMaxPlayerCount) || 1,
                            1,
                            64,
                            1,
                            (v) => setServerMaxPlayerCount(String(v)),
                            -1
                          )
                        }
                      >
                      ...
                      <div className="sevendays-input flex items-center justify-center select-none">
                        {serverMaxPlayerCount}
                      </div>
                      <span
                        className="sevendays-input-arrow"
                  ...
                  <div className="sevendays-input-row">
                    ...
                    <div className="sevendays-input-container">
                      <span
                        ...
                        onClick={() =>
                          handleCycleNumber(
                            parseInt(serverPort) || 26900,
                            1024,
                            65535,
                            1,
                            (v) => setServerPort(String(v)),
                            -1
                          )
                        }
                      >
                ...
                <>
                  <div className="sevendays-input-row">
                    ...
                    <div className="sevendays-input-container">
                      <span
                        className="sevendays-input-arrow"
                        onClick={() =>
                          handleCycleNumber(ramLimit, 1, sysInfo.totalMem, 0.5, setRamLimit, -1)
                        }
                      >
                        &lt;
                      </span>
                      <div className="sevendays-input flex items-center justify-center select-none">
                        {ramLimit.toFixed(1)} GB
                      </div>
                      <span
                        className="sevendays-input-arrow"
                        onClick={() =>
                  ...
                  <div className="sevendays-input-row">
                    ...
                    <div className="sevendays-input-container">
                      <span
                        className="sevendays-input-arrow"
                        onClick={() => handleCycleNumber(cpuLimit, 10, 100, 5, setCpuLimit, -1)}
                      >
                        &lt;
                      </span>
                      <div className="sevendays-input flex items-center justify-center select-none">
