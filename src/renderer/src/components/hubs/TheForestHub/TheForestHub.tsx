...
export const TheForestHub: React.FC = () => {
  ...
  return (
    <div
      className="gamehub-theme flex-1 flex flex-col relative overflow-hidden dayz-scrollbars bg-black theforest-ui"
      data-game="the-forest"
    >
        ...
        <div className="hub-header-row flex justify-between items-center relative z-20">
          <div className="flex items-center gap-4">
            <button
              ...
              className="p-2 text-white hover:text-[var(--forest-yellow)] transition-colors flex items-center justify-center group"
            ...
            <h2 className="hub-title text-4xl font-bold text-white uppercase tracking-wider">
              {activeServer.name}
            </h2>
          </div>
          ...
          <div className="hub-header-actions flex gap-4 items-center">
            <div className="flex bg-[var(--forest-gray)] items-center">
              <button
                ...
                className={`relative overflow-hidden group px-4 py-2 transition-all flex items-center justify-center ${tunnelStatus === 'Online' ? 'text-[var(--forest-green)]' : tunnelStatus === 'Starting...' ? 'text-[var(--forest-gray-light)] cursor-not-allowed' : 'text-white hover:text-[var(--forest-yellow)]'}`}
              >
                <span
              ...
              <button
                ...
                className="px-3 text-white hover:text-[var(--forest-yellow)] transition-colors flex items-center justify-center"
            ...
            <button
              ...
              className="forest-btn hover:!text-[var(--forest-red)]"
            >
              DELETE
            </button>
            <button
              ...
              className={`forest-btn ${activeServer.status === 'Online' ? 'hover:!text-[var(--forest-red)]' : 'hover:!text-[var(--forest-green)]'}`}
            >
