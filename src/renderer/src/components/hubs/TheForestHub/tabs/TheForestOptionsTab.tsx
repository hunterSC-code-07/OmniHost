...
export const TheForestOptionsTab: React.FC = () => {
  ...
  const updateSteamToken = (newToken: string) => {
    if (configContent.match(/^serverSteamAccount /m)) {
      setConfigContent(
        configContent.replace(/^serverSteamAccount .*$/m, `serverSteamAccount ${newToken}`)
      )
    } else {
  ...
  if (isLoading) {
    return (
      <div className="flex-1 flex items-center justify-center text-white font-bold text-lg uppercase tracking-widest">
    ...
    >
      <div className="bg-transparent flex flex-col px-12 py-8 gap-12 text-white font-bold min-h-full">
        <div className="flex justify-between items-center pb-4 border-b border-white/10">
          <h3 className="forest-title !text-3xl text-[var(--forest-yellow)]">
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col">
              ...
              <div className="forest-input-row">
                ...
                <div className="forest-input-container">
                  <span className="forest-input-arrow" onClick={() => updateVAC(!enableVAC)}>
                    &lt;
                  </span>
                  <div
                    className="flex-1 text-center font-bold text-sm tracking-wider cursor-pointer"
