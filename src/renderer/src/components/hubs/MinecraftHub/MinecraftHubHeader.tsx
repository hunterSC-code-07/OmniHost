...
export const MinecraftHubHeader: React.FC = () => {
  ...
  const handleTunnel = async () => {
    if (tunnelStatus === 'Offline' || tunnelStatus === '') {
      // @ts-ignore
      await window.api.system.startTunnel(tunnelIp, 'minecraft', activeServer.port)
      ...
      <div className="flex justify-between items-center relative z-20">
        <div className="flex items-center gap-4">
          <button
            ...
            className="minecraft-btn flex items-center justify-center p-2"
        ...
        <div className="flex gap-3 items-center">
          <div className="flex">
            <button
              ...
              className={`minecraft-btn flex items-center justify-center ${tunnelStatus === 'Online' ? 'minecraft-btn-active' : ''}`}
            ...
            <button
              ...
              className="minecraft-btn flex items-center justify-center ml-1"
          ...
          <button
            ...
            className="minecraft-btn minecraft-btn-red font-bold"
          >
          ...
          <button
            ...
            className={`minecraft-btn font-bold ${activeServer.status === 'Online' ? 'minecraft-btn-red' : 'minecraft-btn-green'}`}
          >
          ...
          <button
            ...
            className="minecraft-btn minecraft-btn-green font-bold"
          >
