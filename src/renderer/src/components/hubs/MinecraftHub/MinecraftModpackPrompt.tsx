...
export const MinecraftModpackPrompt: React.FC = () => {
  const { showModpackPrompt, setShowModpackPrompt, onRedirectToCreateModpack } =
      ...
      <div className="bg-surface/80 backdrop-blur-xl border border-outline-variant/30 shadow-2xl rounded-2xl w-full max-w-md overflow-hidden relative">
        ...
        <div className="p-8 relative z-10">
          ...
          <p className="text-gray-400 mb-8 leading-relaxed">
            Moving existing vanilla or lightly-modded worlds into heavy CurseForge modpacks can be
            complicated and cause corruption. Would you like to create a{' '}
