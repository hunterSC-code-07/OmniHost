...
export const SonsOfTheForestPlayersTab: React.FC<SonsOfTheForestPlayersTabProps> = ({
  serverId
}) => {
              ...
              onlinePlayers.map((playerName, idx) => (
                <div key={idx} className="sotf-row hover:bg-[#1a1a1a]">
                  <div className="flex items-center gap-4 w-[40%]">
                    <span className="material-symbols-outlined text-[var(--sotf-text-dim)]">
                      person
                    </span>
                  ...
                  <div className="w-[60%] flex justify-end gap-4">
                    <button
                      onClick={() => handleKick(playerName)}
                      className="sotf-btn text-sm hover:text-[var(--sotf-highlight)]"
                    >
                      KICK
                    </button>
                    <button
