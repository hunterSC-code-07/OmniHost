...
export const SonsOfTheForestOptionsTab: React.FC = () => {
  ...
  if (isLoading) {
    return (
      <div className="flex-1 flex items-center justify-center sotf-glitch-text text-xl">
        LOADING...
      </div>
    )
  }
      ...
      <div className="w-full max-w-4xl flex-1 flex flex-col mt-4 mb-4">
        ...
        <div className="h-[40px] w-full bg-[var(--sotf-panel)] mb-6 flex items-center px-4 overflow-hidden border-l-4 border-l-[var(--sotf-highlight)]">
          {hoveredOption ? (
            ...
            <p className="text-sm font-bold text-[var(--sotf-text-dim)] uppercase">
          ...
          <div className="flex flex-col mb-12">
            ...
            <div
              ...
              onMouseEnter={() =>
                setHoveredOption({
                  label: 'SERVER NAME',
                  desc: 'THE NAME DISPLAYED IN THE SERVER BROWSER'
                })
              }
            ...
            <div
              ...
              onMouseEnter={() =>
                setHoveredOption({
                  label: 'IP ADDRESS',
                  desc: 'BIND IP ADDRESS. 0.0.0.0 IS REQUIRED FOR TUNNELS'
                })
              }
              onMouseLeave={() => setHoveredOption(null)}
            >
            ...
            <div
              ...
              onMouseEnter={() =>
                setHoveredOption({
                  label: 'STEAM TOKEN',
                  desc: 'REQUIRED FOR PUBLIC SERVERS. APP ID 1326470'
                })
              }
              onMouseLeave={() => setHoveredOption(null)}
            >
            ...
            <div
              ...
              onMouseEnter={() =>
                setHoveredOption({
                  label: 'RAW CONFIG',
                  desc: 'DIRECTLY EDIT THE DEDICATEDSERVER.CFG FILE'
                })
              }
              onMouseLeave={() => setHoveredOption(null)}
            >
