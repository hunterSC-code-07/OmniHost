...
export function DashboardHub({ getGameImageUrl, isGameSupported }: any) {
  const { servers, setActiveServerId, startServer, stopServer, restartServer, deleteServer } =
    useServerStore()
  const {
    activeGameHub,
    setHoveredGame,
              ...
              <div className="w-full flex flex-col relative min-h-full pb-8">
                ...
                <div className="px-gutter py-stack-md relative z-10">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {/* Minecraft Hub */}
                    <div
                      onMouseEnter={() => setHoveredGame('Minecraft')}
                      onMouseLeave={() => setHoveredGame(null)}
                      onClick={() => setActiveGameHub('Minecraft')}
                      className="group relative rounded-xl overflow-hidden bg-surface-container h-[250px] flex flex-col justify-end transition-all duration-300 hover:shadow-[0_0_30px_rgba(76,175,80,0.15)] ring-1 hover:ring-primary cursor-pointer ring-surface-container-high"
                    >
                      <motion.div
                        layoutId={`game-bg-Minecraft`}
                        ...
                        style={{ backgroundImage: `url('${getGameImageUrl('Minecraft')}')` }}
                      ></motion.div>
                      ...
                      <div className="relative z-20 p-6 flex flex-col gap-2 w-full">
                        ...
                        <h2 className="font-headline-lg text-headline-lg text-on-surface leading-tight group-hover:text-primary transition-colors drop-shadow-lg shadow-black">
                          Minecraft
                        </h2>
                      </div>
                    </div>
                    ...
                    {/* Palworld Hub */}
                    <div
                      onMouseEnter={() => setHoveredGame('Palworld')}
                      onMouseLeave={() => setHoveredGame(null)}
                      onClick={() => setActiveGameHub('Palworld')}
                      className="group relative rounded-xl overflow-hidden bg-surface-container h-[250px] flex flex-col justify-end transition-all duration-300 hover:shadow-[0_0_30px_rgba(66,192,255,0.2)] ring-1 hover:ring-[#42c0ff] cursor-pointer ring-surface-container-high"
                    >
                      <motion.div
                        layoutId={`game-bg-Palworld`}
                        className="absolute inset-0 bg-cover bg-center z-0 transition-all duration-700 ease-out group-hover:scale-105 blur-[3px] group-hover:blur-0 contrast-125 saturate-[1.2] brightness-75 group-hover:brightness-100"
                        style={{ backgroundImage: `url('${getGameImageUrl('Palworld')}')` }}
                      ></motion.div>
                      <div className="absolute inset-0 bg-gradient-to-t from-surface-container-lowest via-surface-container-lowest/80 to-transparent z-10 transition-opacity duration-500 group-hover:opacity-60"></div>
                      <div className="relative z-20 p-6 flex flex-col gap-2 w-full">
                        <p className="font-label-sm text-label-sm text-primary uppercase tracking-widest mb-1 shadow-black drop-shadow-md">
                        ...
                        <h2 className="font-headline-lg text-headline-lg text-on-surface leading-tight group-hover:text-[#42c0ff] transition-colors drop-shadow-lg shadow-black">
                          Palworld
                        </h2>
                      </div>
                    </div>
                    ...
                    {/* DayZ Hub */}
                    <div
                      onMouseEnter={() => setHoveredGame('DayZ')}
                      onMouseLeave={() => setHoveredGame(null)}
                      onClick={() => setActiveGameHub('DayZ')}
                      className="group relative rounded-xl overflow-hidden bg-surface-container h-[250px] flex flex-col justify-end transition-all duration-300 hover:shadow-[0_0_30px_rgba(239,68,68,0.2)] ring-1 hover:ring-red-500 cursor-pointer ring-surface-container-high"
                    >
                      <motion.div
                        layoutId={`game-bg-DayZ`}
                        className="absolute inset-0 bg-cover bg-center z-0 transition-all duration-700 ease-out group-hover:scale-105 blur-[3px] group-hover:blur-0 contrast-125 saturate-[1.2] brightness-75 group-hover:brightness-100"
                        style={{ backgroundImage: `url('${getGameImageUrl('DayZ')}')` }}
                      ></motion.div>
                      <div className="absolute inset-0 bg-gradient-to-t from-surface-container-lowest via-surface-container-lowest/80 to-transparent z-10 transition-opacity duration-500 group-hover:opacity-60"></div>
                      <div className="relative z-20 p-6 flex flex-col gap-2 w-full">
                        <p className="font-label-sm text-label-sm text-primary uppercase tracking-widest mb-1 shadow-black drop-shadow-md">
                        ...
                        <h2 className="font-headline-lg text-headline-lg text-on-surface leading-tight group-hover:text-red-400 transition-colors drop-shadow-lg shadow-black">
                          DayZ
                        </h2>
                      </div>
                    </div>
                    ...
                    {/* Satisfactory Hub */}
                    <div
                      onMouseEnter={() => setHoveredGame('Satisfactory')}
                      onMouseLeave={() => setHoveredGame(null)}
                      onClick={() => setActiveGameHub('Satisfactory')}
                      className="group relative rounded-xl overflow-hidden bg-surface-container h-[250px] flex flex-col justify-end transition-all duration-300 hover:shadow-[0_0_30px_rgba(250,149,73,0.2)] ring-1 hover:ring-[#fa9549] cursor-pointer ring-surface-container-high"
                    >
                      <motion.div
                        layoutId={`game-bg-Satisfactory`}
                        className="absolute inset-0 bg-cover bg-center z-0 transition-all duration-700 ease-out group-hover:scale-105 blur-[3px] group-hover:blur-0 contrast-125 saturate-[1.2] brightness-75 group-hover:brightness-100"
                        style={{ backgroundImage: `url('${getGameImageUrl('Satisfactory')}')` }}
                      ></motion.div>
                      <div className="absolute inset-0 bg-gradient-to-t from-surface-container-lowest via-surface-container-lowest/80 to-transparent z-10 transition-opacity duration-500 group-hover:opacity-60"></div>
                      <div className="relative z-20 p-6 flex flex-col gap-2 w-full">
                        <p className="font-label-sm text-label-sm text-primary uppercase tracking-widest mb-1 shadow-black drop-shadow-md">
                        ...
                        <h2 className="font-headline-lg text-headline-lg text-on-surface leading-tight group-hover:text-[#fa9549] transition-colors drop-shadow-lg shadow-black">
                          Satisfactory
                        </h2>
                      </div>
                    </div>
                    ...
                    {servers.length === 0 ? (
                      <div className="py-20 flex flex-col items-center justify-center text-center px-4">
                        ...
                        <p className="font-body-md text-body-md text-on-surface-variant max-w-md">
                          Select a Game Hub above to create and configure your first dedicated
                          server instance.
                        </p>
                      </div>
                    ) : (
                            ...
                            {servers.map((server, idx) => (
                              ...
                              >
                                <td className="px-6 py-4">
                                  <div className="flex items-center gap-2">
                                    <span
                                      className={`w-2.5 h-2.5 rounded-full ${server.status === 'Online' ? 'bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.6)]' : 'bg-red-500/50'}`}
                                    ></span>
                                    <span
                                      className={`font-label-sm tracking-widest uppercase ${server.status === 'Online' ? 'text-green-400' : 'text-on-surface-variant'}`}
                                    >
                                      {server.status}
                                    </span>
                                  </div>
                                ...
                                <td className="px-6 py-4">
                                  <div className="flex items-center gap-2">
                                    <div className="w-6 h-6 rounded bg-surface-container-highest overflow-hidden border border-outline-variant/30">
                                      <img
                                        src={getGameImageUrl(server.game)}
                                  ...
                                  >
                                    {server.status === 'Offline' ? (
                                      <button
                                        ...
                                        className="w-8 h-8 rounded bg-green-500/10 text-green-400 hover:bg-green-500/20 flex items-center justify-center transition-colors"
                                        title="Start Server"
                                      >
                                      ...
                                      <>
                                        <button
                                          ...
                                          className="w-8 h-8 rounded bg-amber-500/10 text-amber-400 hover:bg-amber-500/20 flex items-center justify-center transition-colors"
                                        ...
                                        <button
                                          ...
                                          className="w-8 h-8 rounded bg-red-500/10 text-red-400 hover:bg-red-500/20 flex items-center justify-center transition-colors"
                                          title="Stop Server"
                                        >
                                          <span className="material-symbols-outlined text-[18px]">
                                            stop
                                    ...
                                    <button
                                      ...
                                      className="w-8 h-8 rounded bg-surface-container-highest text-on-surface-variant hover:text-red-400 hover:bg-red-500/10 flex items-center justify-center transition-colors ml-2"
                                      title="Delete Server"
                                    >
                                      <span className="material-symbols-outlined text-[18px]">
                                        delete
              ...
              <div className="w-full flex flex-col relative min-h-full pb-8">
                ...
                <div className="relative z-10 px-gutter pt-stack-lg pb-stack-lg flex flex-col gap-6">
                  <button
                    ...
                    className="self-start flex items-center gap-2 text-on-surface-variant hover:text-primary transition-colors font-label-md text-label-md uppercase tracking-widest mb-2"
                  >
                    ...
                    <>
                              ...
                              <>
                                ...
                                <button
                                  onClick={async () => {
                                    if (
                                      confirm(
                                        'Are you sure you want to delete the cached DayZ base files?'
                                      )
                                    ) {
                                      // @ts-ignore
                      ...
                      {servers.filter((s: any) => s.game.includes(activeGameHub)).length === 0 ? (
                        <div className="py-20 flex flex-col items-center justify-center text-center px-4">
                          ...
                          <h3 className="font-headline-sm text-headline-sm text-on-surface mb-2">
                            No {activeGameHub} servers found
                          </h3>
                          <p className="font-body-md text-body-md text-on-surface-variant max-w-md">
                            Click the "NEW {activeGameHub.toUpperCase()} SERVER" button above to
                            create one.
                          </p>
                        </div>
                      ) : (
                        <div className="flex flex-col gap-4">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {servers
                              .filter((s: any) => s.game.includes(activeGameHub))
                              .map((server: any) => (
                                <div
                                  key={server.id}
                                  onClick={() => setActiveServerId(server.id)}
                                  className="group relative rounded-xl overflow-hidden glass-panel p-6 flex flex-col gap-4 border border-surface-container-high hover:border-primary transition-all duration-300 ease-out hover:-translate-y-1.5 cursor-pointer hover:shadow-[0_15px_30px_rgba(0,0,0,0.4)]"
                                >
                                  <div className="flex justify-between items-start">
                                    ...
                                    <div className="flex items-center gap-2 bg-background/50 px-3 py-1.5 rounded-full border border-surface-container-highest">
                                      {server.status === 'Online' ? (
                                        <>
                                          <span className="w-2 h-2 rounded-full bg-[#4CAF50] shadow-[0_0_8px_rgba(76,175,80,0.8)]"></span>
                                  ...
                                  <div className="flex flex-col gap-3 mt-4">
                                    {server.game !== 'DayZ' && (
                                      <div className="flex items-center gap-2 text-on-surface-variant font-label-md text-label-md">
                                        ...
                                        <span className="font-mono text-on-surface tracking-wider">
                                          {tunnelIp}:{server.port || 25565}
                                        </span>
                                      </div>
                                    )}
                    ...
                    <div className="flex flex-col gap-6">
                      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-surface-container-high pb-6">
                        <div>
                          ...
                          <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mt-1">
                            Dedicated server orchestration and automated deployment for{' '}
                            {activeGameHub}.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="glass-panel p-8 md:p-12 rounded-2xl border border-surface-container-high flex flex-col items-center text-center max-w-3xl mx-auto my-6 relative overflow-hidden">
                        ...
                        <p className="font-body-lg text-body-lg text-on-surface-variant max-w-xl mb-8 leading-relaxed">
                          Dedicated server installation, live console telemetry, mod loading, and
                          automatic port tunneling for {activeGameHub} are currently in active
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full text-left mb-8">
                          <div className="p-4 rounded-xl bg-surface-container/60 border border-surface-container-high">
                            <span className="material-symbols-outlined text-primary text-xl mb-2">
                              dns
                            </span>
                            <h4 className="font-bold text-sm text-on-surface">Automated Server</h4>
                            <p className="text-xs text-on-surface-variant mt-1">
                              One-click server deployment and updates
                            </p>
                          </div>
                          <div className="p-4 rounded-xl bg-surface-container/60 border border-surface-container-high">
                            <span className="material-symbols-outlined text-primary text-xl mb-2">
                            ...
                            <p className="text-xs text-on-surface-variant mt-1">
                              Full graphical server properties editor
                            </p>
                          </div>
                          <div className="p-4 rounded-xl bg-surface-container/60 border border-surface-container-high">
                            <span className="material-symbols-outlined text-primary text-xl mb-2">
                            ...
                            <p className="text-xs text-on-surface-variant mt-1">
                              Real-time metrics, logs, and player list
                            </p>
                          </div>
                        </div>
