      ...
      <div className="flex justify-between items-center relative z-20">
        <div className="flex items-center gap-4">
          <button
            ...
            className="terraria-btn group px-3 py-2 transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-x-0.5"
            title="Back to Dashboard"
          >
            <span className="material-symbols-outlined text-[20px] group-hover:-translate-x-1 transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]">
              arrow_back
            </span>
          </button>
        ...
        <div className="flex gap-3 items-center">
          {tunnelStatus === 'Online' && tunnelIp && (
            ...
            >
              {copied ? (
                ...
                <>
                  <span className="text-sm leading-tight text-center group-hover:scale-105 transition-transform">
                    {tunnelIp}
                  </span>
                  <span className="text-[10px] uppercase tracking-widest text-center mt-0.5">
                    Port: 7777
                  </span>
                </>
              )}
          ...
          <button
            ...
            className="terraria-btn terraria-btn-red"
          >
            DELETE
          </button>
          <button
            ...
            className={`terraria-btn ${activeServer.status === 'Online' ? 'terraria-btn-red' : 'terraria-btn-green'}`}
          >
