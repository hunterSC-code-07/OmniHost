      ...
      <div className="bg-[#0a0a0a] p-8 rounded-xl border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.9),inset_0_1px_2px_rgba(255,255,255,0.1)] w-full max-w-md relative">
        ...
        <div className="relative z-10">
          ...
          <p className="text-sm text-gray-400 mb-6">
            To download the DayZ Server files, you must log into SteamCMD. Your credentials are only
            sent securely to Steam's servers and are not stored.
          </p>
          ...
          <div className="space-y-4">
            ...
            {isSteamGuardRequired && (
              <div>
                <label className="block text-sm font-bold text-yellow-500 mb-1">
                  Steam Guard Code
                </label>
                <input
                  type="text"
                ...
                <p className="text-xs text-yellow-500/70 mt-1">
                  Check your email or Steam mobile app for the code.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="flex justify-end gap-3 mt-8">
            ...
            <button
              ...
              disabled={
                !steamUsername ||
                !steamPassword ||
                (isSteamGuardRequired && !steamGuardCode) ||
                isUpdating
              }
