        ...
        <div className="p-6 relative z-10">
          <div className="flex items-center gap-4 mb-6">
            <div className="bg-brand/10 w-14 h-14 flex items-center justify-center rounded-xl border border-brand/30 shadow-[0_0_15px_rgba(76,175,80,0.2)]">
              <span className="material-symbols-outlined text-brand text-3xl leading-none">
                cell_tower
              </span>
            </div>
            <div>
          ...
          <div className="mb-8">
            ...
            <p className="text-xs text-on-surface-variant/60 mt-2">
              This IP will be used to generate the frpc.toml configuration. Changes take effect on
              the next tunnel start.
            </p>
          </div>
