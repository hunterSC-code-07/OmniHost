...
const api = {
  server: {
    ...
    ) => ipcRenderer.invoke('create-server', name, game, type, version, loaderVersion),
  ...
  minecraft: {
    ...
    installCurseforgeModpack: (id: number, modId: number | string, version: string) =>
    ...
    getCurseforgeFile: (modId: number | string, fileId: number | string) =>
    ...
    getInstalledModDependencies: (id: number) =>
      ipcRenderer.invoke('get-installed-mod-dependencies', id),
