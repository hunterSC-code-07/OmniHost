...
This directory keeps repository utilities separate from the application source.

- `maintenance/` contains one-off source maintenance and migration scripts.
- `diagnostics/` contains manual troubleshooting scripts and probes.
